-- 부동산 테이블 데이터
insert into real_estate (id, beop_jeong_dong, beop_jeong_dong_code, construct_year, contract_day, contract_month,
                         contract_year, floor, jeon_yong_area, name, parcel_number, real_estate_type)
values (10649088, '염창동', '11500', 2005, 22, 1, 2011, 12, 74, '강변힐스테이트', '299', 'APT_TRADE');

insert into real_estate (id, beop_jeong_dong, beop_jeong_dong_code, construct_year, contract_day, contract_month,
                         contract_year, floor, jeon_yong_area, name, parcel_number, real_estate_type)
values (1234432, '염창동', '11500', 2000, 30, 12, 2001, 10, 102, '염창현대1차', '288', 'APT_RENT');

insert into real_estate (id, beop_jeong_dong, beop_jeong_dong_code, construct_year, contract_day, contract_month,
                         contract_year, floor, jeon_yong_area, name, parcel_number, real_estate_type)
values (10649089, '염창동', '11500', 2010, 14, 5, 2014, 4, 102, '염창동롯데캐슬', '272-11', 'APT_TRADE');
...
values (10649088, '10.02.01', 'O', '서울 강서구', 110000, '중개거래');

insert into sale (id, cancel_deal_day, cancel_deal_type, agent_address, deal_amount, deal_type)
values (10649089, '15.12.01', 'O', '서울 강서구', 100000, '중개거래');
...
values (1234432, '23.08~25.08', '갱신', 10000, 9000, 200, 185, '사용', null);